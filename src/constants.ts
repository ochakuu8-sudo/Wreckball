...
// ===== ボール =====
// Pinball feel: heavier gravity, snappier rebounds, and enough top speed for fast lanes.
...
export const WALL_DAMPING = 0.80;
// 建物反発係数: 1.0 = 完全弾性、< 1.0 で衝突ごとに減速。下面ヒットには別係数。
export const RESTITUTION_BUILDING = 0.90;          // 通常の建物反射 (上面/側面)
export const RESTITUTION_BUILDING_BOTTOM = 0.62;   // 下から建物の底に当たった時
...
export const FLIPPER_ACTIVE_DEG = 32;
export const FLIPPER_POWER = 16;
export const FLIPPER_SPEED_DEG = 740; // deg/s
...
export const BUILDING_DEFS: Record<BuildingSize, {
  ...
  // score 設計: 家具 1-5 / 小建物 100 / 中型 400 / 大型 1500 / 超大 5000 / 城 50000
  //   大きさに応じたメリハリ (1:1000 の幅) でスコア狙い建物の優先順位が生まれる設計
  house:          { w: 16, h: 20, hp: 1, score:   100, humanMin:  3,  humanMax:  7  },
  convenience:    { w: 24, h: 22, hp: 1, score:   120, humanMin:  8,  humanMax: 15  },
  shop:           { w: 22, h: 25, hp: 1, score:   150, humanMin: 10,  humanMax: 20  },
  restaurant:     { w: 20, h: 28, hp: 1, score:   150, humanMin: 15,  humanMax: 30  },
  apartment:      { w: 24, h: 40, hp: 2, score:   400, humanMin: 20,  humanMax: 40  },
  temple:         { w: 30, h: 30, hp: 2, score:   600, humanMin: 20,  humanMax: 45  },
  parking:        { w: 36, h: 35, hp: 2, score:   300, humanMin: 25,  humanMax: 55  },
  office:         { w: 30, h: 55, hp: 3, score:  1200, humanMin: 55,  humanMax: 95  },
  tower:          { w: 35, h: 70, hp: 3, score:  2000, humanMin: 70,  humanMax: 120 },
  skyscraper:     { w: 28, h: 90, hp: 3, score:  3500, humanMin: 80,  humanMax: 140 },
  hospital:       { w: 35, h: 50, hp: 3, score:  1500, humanMin: 50,  humanMax: 90  },
  school:         { w: 40, h: 45, hp: 3, score:  1500, humanMin: 70,  humanMax: 120 },
  // ===== 1-A 住宅系 =====
  townhouse:      { w: 18, h: 24, hp: 1, score:   100, humanMin:  4,  humanMax:  9  },
  mansion:        { w: 32, h: 28, hp: 1, score:   250, humanMin:  6,  humanMax: 16  },
  garage:         { w: 20, h: 14, hp: 1, score:    50, humanMin:  1,  humanMax:  4  },
  shed:           { w: 12, h: 12, hp: 1, score:    50, humanMin:  0,  humanMax:  2  },
  greenhouse:     { w: 22, h: 18, hp: 1, score:    80, humanMin:  2,  humanMax:  6  },
  daycare:        { w: 28, h: 22, hp: 1, score:   120, humanMin: 15,  humanMax: 30  },
  clinic:         { w: 26, h: 28, hp: 1, score:   180, humanMin: 18,  humanMax: 35  },
  shrine:         { w: 26, h: 28, hp: 2, score:   500, humanMin: 15,  humanMax: 35  },
  apartment_tall: { w: 26, h: 58, hp: 3, score:  1200, humanMin: 35,  humanMax: 65  },
  // ===== 1-B 商業系 =====
  cafe:           { w: 18, h: 20, hp: 1, score:   100, humanMin: 12,  humanMax: 22  },
  bakery:         { w: 16, h: 18, hp: 1, score:   100, humanMin:  8,  humanMax: 16  },
  bookstore:      { w: 18, h: 22, hp: 1, score:   100, humanMin:  8,  humanMax: 15  },
  pharmacy:       { w: 20, h: 22, hp: 1, score:   100, humanMin:  8,  humanMax: 14  },
  supermarket:    { w: 40, h: 28, hp: 2, score:   500, humanMin: 25,  humanMax: 45  },
  karaoke:        { w: 24, h: 30, hp: 2, score:   400, humanMin: 18,  humanMax: 35  },
  pachinko:       { w: 30, h: 28, hp: 2, score:   400, humanMin: 20,  humanMax: 35  },
  laundromat:     { w: 18, h: 18, hp: 1, score:    80, humanMin:  5,  humanMax: 12  },
  florist:        { w: 14, h: 18, hp: 1, score:    80, humanMin:  5,  humanMax: 10  },
  ramen:          { w: 16, h: 20, hp: 1, score:   100, humanMin: 10,  humanMax: 22  },
  izakaya:        { w: 20, h: 22, hp: 1, score:   120, humanMin: 15,  humanMax: 30  },
  game_center:    { w: 28, h: 26, hp: 2, score:   400, humanMin: 18,  humanMax: 32  },
  // ===== 1-C 公共系 =====
  bank:           { w: 28, h: 32, hp: 2, score:   700, humanMin: 20,  humanMax: 45  },
  post_office:    { w: 24, h: 26, hp: 1, score:   150, humanMin: 12,  humanMax: 25  },
  library:        { w: 36, h: 34, hp: 2, score:   600, humanMin: 25,  humanMax: 55  },
  museum:         { w: 40, h: 38, hp: 2, score:   800, humanMin: 25,  humanMax: 50  },
  city_hall:      { w: 40, h: 44, hp: 3, score:  2000, humanMin: 30,  humanMax: 55  },
  fire_station:   { w: 30, h: 30, hp: 2, score:   500, humanMin: 10,  humanMax: 22  },
  police_station: { w: 30, h: 32, hp: 2, score:   500, humanMin: 15,  humanMax: 30  },
  train_station:  { w: 50, h: 36, hp: 3, score:  2500, humanMin: 35,  humanMax: 70  },
  movie_theater:  { w: 38, h: 32, hp: 2, score:   600, humanMin: 30,  humanMax: 55  },
  gas_station:    { w: 30, h: 18, hp: 1, score:   150, humanMin:  3,  humanMax:  8  },
  // ===== 1-D ランドマーク =====
  clock_tower:    { w: 16, h: 68, hp: 2, score:   600, humanMin:  5,  humanMax: 12  },
  radio_tower:    { w: 10, h: 88, hp: 3, score:  1500, humanMin:  2,  humanMax:  8  },
  ferris_wheel:   { w: 44, h: 48, hp: 3, score:  2000, humanMin: 15,  humanMax: 35  },
  stadium:        { w: 60, h: 38, hp: 3, score:  5000, humanMin: 80,  humanMax: 160 },
  water_tower:    { w: 18, h: 48, hp: 1, score:    80, humanMin:  0,  humanMax:  3  },
  // ===== 特大施設 =====
  department_store: { w: 54, h: 38, hp: 3, score: 2500, humanMin: 50,  humanMax: 100 },
  // ===== 港湾・工業 (Stage 4) =====
  warehouse:       { w: 52, h: 28, hp: 2, score:   500, humanMin:  8,  humanMax: 20  },
  crane_gantry:    { w: 34, h: 78, hp: 3, score:  2000, humanMin:  2,  humanMax:  8  },
  container_stack: { w: 32, h: 30, hp: 2, score:   400, humanMin:  0,  humanMax:  4  },
  factory_stack:   { w: 42, h: 62, hp: 3, score:  2500, humanMin: 20,  humanMax: 45  },
  silo:            { w: 20, h: 48, hp: 2, score:   400, humanMin:  0,  humanMax:  3  },
  // ===== 和風・古都 (Stage 3) =====
  pagoda:          { w: 24, h: 72, hp: 3, score:  2500, humanMin:  8,  humanMax: 25  },
  ryokan:          { w: 40, h: 30, hp: 2, score:   600, humanMin: 18,  humanMax: 38  },
  kominka:         { w: 22, h: 22, hp: 1, score:   100, humanMin:  4,  humanMax: 10  },
  chaya:           { w: 20, h: 20, hp: 1, score:   100, humanMin: 10,  humanMax: 22  },
  // ===== テーマパーク・祭り (Stage 5) =====
  carousel:        { w: 38, h: 32, hp: 2, score:   700, humanMin: 15,  humanMax: 35  },
  roller_coaster:  { w: 60, h: 60, hp: 3, score:  4000, humanMin: 20,  humanMax: 45  },
  yatai:           { w: 20, h: 16, hp: 1, score:    80, humanMin: 12,  humanMax: 25  },
  big_tent:        { w: 48, h: 36, hp: 2, score:   600, humanMin: 25,  humanMax: 55  },
  // ===== Stage 1 ミニチュア追加 =====
  shotengai_arcade:     { w: 40, h:  6, hp: 1, score: 100, humanMin:  0,  humanMax:  3 },
  bus_terminal_shelter: { w: 32, h: 10, hp: 1, score: 120, humanMin: 15,  humanMax: 30 },
  fountain_pavilion:    { w: 28, h: 14, hp: 2, score: 300, humanMin:  5,  humanMax: 15 },
  // ===== Stage 2 夜街追加 =====
  snack:          { w: 16, h: 22, hp: 1, score:   100, humanMin:  6,  humanMax: 14 },
  love_hotel:     { w: 32, h: 42, hp: 2, score:   500, humanMin: 10,  humanMax: 28 },
  business_hotel: { w: 24, h: 55, hp: 3, score:  1500, humanMin: 30,  humanMax: 60  },
  mahjong_parlor: { w: 22, h: 26, hp: 1, score:   180, humanMin:  8,  humanMax: 18 },
  club:           { w: 28, h: 30, hp: 2, score:   500, humanMin: 18,  humanMax:  35 },
  capsule_hotel:  { w: 40, h: 28, hp: 2, score:   500, humanMin: 25,  humanMax:  50 },
  // ===== Stage 3 和風追加 =====
  kura:           { w: 18, h: 20, hp: 1, score:   100, humanMin:  2,  humanMax:  5 },
  machiya:        { w: 24, h: 32, hp: 2, score:   300, humanMin: 15,  humanMax: 30 },
  onsen_inn:      { w: 44, h: 36, hp: 2, score:   700, humanMin: 20,  humanMax: 45 },
  tahoto:         { w: 22, h: 48, hp: 2, score:   700, humanMin:  5,  humanMax: 15 },
  // ===== Stage 3 和風小建物の追加バリエーション =====
  dojo:           { w: 24, h: 24, hp: 1, score:   180, humanMin:  5,  humanMax: 15 },
  wagashi:        { w: 18, h: 20, hp: 1, score:   100, humanMin:  8,  humanMax: 16 },
  kimono_shop:    { w: 22, h: 22, hp: 1, score:   120, humanMin:  6,  humanMax: 14 },
  sushi_ya:       { w: 16, h: 20, hp: 1, score:   120, humanMin: 10,  humanMax: 20 },
  // ===== Stage 1 住宅バリエーション =====
